...
public class ModoDanioPermanenteEInactivoPor3Turnos extends Modo {
    private Modo siguienteModo;

    public ModoDanioPermanenteEInactivoPor3Turnos() {
        this.siguienteModo = new ModoDanioPermanenteEInactivoPor2Turnos();
        this.nombreDelModo = "Modo Danio Permanente e Inactivo Por 3 Turnos";
    }
